...
public class PostgresInit implements DatabaseService {
    ...
    private final String adminGroupTitle = conf.getString("socia.admin.group");
    private final String adminMail = conf.getString("socia.admin.mail");
    private final String adminPassword = conf.getString("socia.admin.pw");
    private final String dummyMail = conf.getString("socia.dummy.mail");
    private final String dummyPassword = conf.getString("socia.dummy.pw");
